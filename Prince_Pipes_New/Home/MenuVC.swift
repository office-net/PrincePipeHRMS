...
class MenuVC: UIViewController{
    ...
    var menuAray = ["Profile","Notification","Directory","Notes","My Team"," Attendance Calendar"," Holiday Calendar","Salary Slip"]
  ...
  //
        ...
        arrimg.append(UIImage(named:"calendar-1.png")!)
        arrimg.append(UIImage(named:"employee-benefit.png")!)
        ...
        if let ProfileImage = UserDefaults.standard.object(forKey: "ImageURL") as? String {
            print(ProfileImage)
            self.imgProfile.image = UIImage(url: URL(string:ProfileImage))
        }
        ...
        if let Language = defaults.string(forKey: "Language") {
            if Language == "English"
            {
                menuAray = ["Profile","Notification","Directory","Notes","My Team"," Attendance Calendar"," Holiday Calendar","Salary Slip"]
                self.tableView.reloadData()
            }
            else
            {
                menuAray = ["प्रोफ़ाइल", "अधिसूचना", "निर्देशिका", "नोट्स", "मेरी टीम", "उपस्थिति कैलेंडर", "अवकाश कैलेंडर","वेतन पर्ची"]
                self.tableView.reloadData()
            }
        }
    ...
    @IBAction func ProfileAction(_ sender: AnyObject) {
        ...
        callImagePicker(sender: sender as! UIButton)
...
extension MenuVC:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblTitle.textColor = base.secondcolor
        ...
        cell.imgView.tintColor = base.firstcolor
        return cell
...
extension MenuVC : UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    func callImagePicker(sender:UIButton) {
        ...
        if let popoverPresentationController = optionMenu.popoverPresentationController {
            ...
            popoverPresentationController.sourceRect = viewForSource.bounds
