...
extension TravelRequisitionVC:UITableViewDataSource,UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let storyboard = UIStoryboard(name: "RequisitionDetails", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "New_Requisition_Details_Page")as! New_Requisition_Details_Page
