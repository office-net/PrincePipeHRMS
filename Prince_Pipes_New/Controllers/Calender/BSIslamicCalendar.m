...
-(void)initializeIslamicCalendar{
    ...
    ViewForCustom.backgroundColor = [UIColor colorWithRed:0.9294117647 green:0.1960784314 blue:0.2156862745 alpha:1];
...
-(void)configureCellLabels:(UILabel*)titelLbl detailLabel:(UILabel *)detailLbl atIndexPath:(NSIndexPath*)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        titelLbl.superview.backgroundColor = [UIColor colorWithRed:0.9294117647 green:0.1960784314 blue:0.2156862745 alpha:1];
