...
class COPendingVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func RequestApi()
    {
        ...
        if let UserID = UserDefaults.standard.object(forKey: "UserID") as? Int {
            parameters = ["TokenNo":"abcHkl7900@8Uyhkj","UserID":UserID,"FromDate":previousMonthStr,"ToDate":nextMonthStr,"DateType":strRequestId,"ReqNo":"","location":"0","Depart":"0","Categ":"0","EmpCode":""]
        }
        else{
    ...
    override func awakeFromNib() {
        ...
        if let Language = defaults.string(forKey: "Language") {
            if Language == "English"
            {
                ...
                self.tRequestCode.text = "Request No"
