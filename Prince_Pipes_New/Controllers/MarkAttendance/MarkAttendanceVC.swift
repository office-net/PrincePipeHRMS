...
class MarkAttendanceVC: UIViewController,CLLocationManagerDelegate,MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        case .unknown, .offline:
            print("Not connected")
            let dialogMessage = UIAlertController(title: base.Title, message: "You are not not connected with internet", preferredStyle: .alert)
            let ok = UIAlertAction(title: base.ok, style: .default, handler: { (action) -> Void in
                    ...
                    if status == 1
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                let alertController = UIAlertController(title: base.Title, message: self.strmag, preferredStyle: .alert)
